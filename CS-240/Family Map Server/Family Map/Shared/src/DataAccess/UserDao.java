    ...
    public void insert(User user) throws DataAccessException {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            if (!user.getGender().equals("m")) {
                if (!user.getGender().equals("f")) throw new DataAccessException("error invalid gender");
            }
            if (user.getPersonID() == "" || user.getPassword() == "" || user.getUserName() == "" ||
            user.getFirstName() == "" || user.getLastName() == "" || user.getEmail() == "") throw new DataAccessException("error missing parameter");
