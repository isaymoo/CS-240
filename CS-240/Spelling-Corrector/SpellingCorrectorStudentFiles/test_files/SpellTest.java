...
public class SpellTest {
    ...
    public void testInsertion(){
        ...
        assertEquals(suggestedWord, WORD, createErrorMessage(guess, WORD, suggestedWord));
    ...
    public void testAlteration(){
        ...
        assertEquals(suggestedWord, "float", createErrorMessage(guess, "float", suggestedWord));
        ...
        guess = "reah";
        suggestedWord = test(WORDS_FILENAME, guess);
        assertEquals(suggestedWord, "yeah", createErrorMessage(guess, "yeah", suggestedWord));
    }
    ...
    public void testBigFile(){
        ...
        assertEquals(suggestedWord, "jason", createErrorMessage(guess, "jason", suggestedWord));

        guess = "is";
        suggestedWord = test(BIG_FILENAME, guess);
        assertEquals(suggestedWord, "is", createErrorMessage(guess, "is", suggestedWord));

        guess = "zupem";
        suggestedWord = test(BIG_FILENAME, guess);
        assertEquals(suggestedWord, "super", createErrorMessage(guess, "super", suggestedWord));

        guess = "cooool";
        suggestedWord = test(BIG_FILENAME, guess);
        assertEquals(suggestedWord, "cool", createErrorMessage(guess, "cool", suggestedWord));

        guess = "absolustly";
        suggestedWord = test(BIG_FILENAME, guess);
        assertEquals(suggestedWord, "absolutely", createErrorMessage(guess, "absolutely", suggestedWord));
    }
